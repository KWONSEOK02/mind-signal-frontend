...
const Expand: React.FC<ExpandProps> = ({ theme }) => {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col flex-1">
      ...
      >
        <h2 className="text-5xl md:text-6xl font-black italic uppercase tracking-tighter -mt-40 bg-[linear-gradient(to_right,#5032D6_0%,#8D58FF_29%,#AB62FF_75%,#66B9F4_85%,#00DA90_100%)] bg-clip-text text-transparent drop-shadow-xl px-3">
          Coming Soon
        </h2>
      </div>
      <div
