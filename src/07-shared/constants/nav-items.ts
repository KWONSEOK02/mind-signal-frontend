 ...
 * 두 곳이 어긋나므로 여기를 정본으로 둠.
 *
 * `url` 이 있는 항목은 외부 링크라 페이지 이동이 아니라 새 탭으로 엶.
 * 작업실 링크가 평문 http 인 것은 별건임 — mind-signal-frontend#75.
 */
